...
p2 <- ggplot(data = dt, aes(lngdp)) + geom_histogram(binwidth = .25, fill = 'orange') +
  labs(x = s_lngdp) +
  geom_text(aes(x = median(dt$lngdp), y = 10), label ='median', color = 'blue', angle = 90, vjust = 1.0) +
  geom_vline(xintercept = median(dt$lngdp), color = 'blue') +
  geom_text(aes(x = mean(dt$lngdp), y = 10), label ='mean', color = 'blue', angle = 90, vjust = 1.0) +
...
p_lm <- ggplot(data = dt, aes(gdp, life_exp)) + gp + l + s_y + s_x +
  ...
  geom_text(aes(x = 6000, y = 46), label = paste("R^2 =", round(r2_lm, 4), sep =" ") , size = 4, hjust = 0)
...
p_lm_ln <- ggplot(data = dt, aes(gdp, life_exp)) + gp +  l + s_y + s_x +
  ...
  geom_text(aes(x = 6000, y = 49), label = "lngdp ~ dfs", size = 4, hjust = 0) +
  geom_text(aes(x = 6000, y = 46), label = paste("R^2 =", round(r2_lm_ln, 4), sep =" "), size = 4, hjust = 0)
...
p_spline <- ggplot(data = dt, aes(gdp, life_exp)) + gp +  l + s_y + s_x +
  ...
  geom_text(aes(x = 6000, y = 49), label = "lngdp ~ dfs", size = 4, hjust = 0) +
  geom_text(aes(x = 6000, y = 46), label = paste("R^2 =", round(r2_spline, 4), sep =" "), size = 4, hjust = 0)
...
p_lm_sq <- ggplot(data = dt, aes(gdp, life_exp)) + gp + l + s_y + s_x +
  ...
  geom_text(aes(x = 6000, y = 49), label = "lngdp ~ dfs", size = 4, hjust = 0) +
  geom_text(aes(x = 6000, y = 46), label = paste("R^2 =", round(r2_lm_sq, 4), sep =" "), size = 4, hjust = 0)
...
p_lm_cub <- ggplot(data = dt, aes(gdp, life_exp)) + gp + l + s_y + s_x +
  ...
  geom_text(aes(x = 6000, y = 49), label = "lngdp ~ dfs", size = 4, hjust = 0) +
  geom_text(aes(x = 6000, y = 46), label = paste("R^2 =", round(r2_lm_cub, 4), sep =" "), size = 4, hjust = 0)
